...
After linking the project to Vercel once, deploy new updates with:

```bash
npm run deploy:vercel
```

The script will install dependencies, run lint, build the project, and deploy it to Vercel production.
