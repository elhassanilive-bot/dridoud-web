      ...
      sections: [
        {
          ...
          items: [
            { href: '/interface?setting=account_settings', label: copy.links.accountSettings, icon: AccountIcon },
            { href: '/interface?setting=security_panel', label: copy.links.securityPanel, icon: ShieldIcon },
            { href: '/interface?setting=verification_requests', label: copy.links.verificationRequests, icon: VerifyIcon },
            { href: '/interface?setting=appearance', label: copy.links.appTheme, icon: ThemeIcon },
            { href: '/interface?setting=notification_settings', label: copy.links.notificationSettings, icon: BellIcon },
            { href: '/interface?setting=verify_account', label: copy.links.verifyAccount, icon: VerifyIcon },
            { href: '/interface?setting=languages', label: copy.links.languages, icon: LanguageIcon },
            { href: '/interface?setting=accounts', label: copy.links.accounts, icon: AccountsIcon },
          ],
        },
        {
          title: copy.columns.privacy,
          items: [
            { href: '/interface?setting=privacy', label: copy.links.accountPrivacy, icon: LockIcon },
            { href: '/interface?setting=activity_status', label: copy.links.activityStatus, icon: ActivityIcon },
            { href: '/interface?setting=account_management', label: copy.links.accountManagement, icon: SettingsIcon },
            { href: '/interface?setting=login_security', label: copy.links.loginSecurity, icon: ShieldIcon },
          ],
        },
        {
          title: copy.columns.tools,
          items: [
            { href: '/interface?setting=mentions', label: copy.links.hashtags, icon: HashIcon },
            { href: '/interface?setting=video_controls', label: copy.links.videoControl, icon: VideoIcon },
          ],
        },
        {
