...
const sections = [
  {
    ...
    icon: "compass",
    body:
      "نطمح إلى بناء مجتمع رقمي عالمي يجمع بين الناس من مختلف الثقافات والاهتمامات، حيث يمكن لكل شخص مشاركة أفكاره، اكتشاف محتوى جديد، والتواصل بدون حدود.",
  },
  {
    id: "mission",
    heading: "مهمتنا",
    icon: "target",
    body:
      "مهمتنا هي توفير منصة تواصل اجتماعي متطورة تجمع بين سهولة الاستخدام، قوة الميزات، وسرعة الأداء مع التركيز على تجربة مستخدم مميزة تنافس أكبر التطبيقات العالمية.",
  ...
  },
  {
    ...
    icon: "lightbulb",
    body:
      "في دريدود، نوفر مجموعة واسعة من الأدوات التي تساعد المستخدمين على مشاركة المحتوى بجميع أنواعه، التفاعل مع الآخرين بسهولة، إنشاء مجتمعات وقنوات خاصة، واكتشاف محتوى جديد بشكل مستمر في بيئة آمنة ومحترمة.",
  },
  {
    id: "commitment",
    heading: "التزامنا",
    icon: "shield",
    body:
      "نلتزم بحماية خصوصية المستخدمين، توفير نظام أمان متقدم، تحسين مستمر للمنصة، والاستماع لآراء المستخدمين وتطوير التطبيق بناءً عليها.",
  ...
  },
  {
    ...
    icon: "community",
    body:
      "دريدود ليس مجرد تطبيق، بل هو مجتمع متكامل يضم مستخدمين من مختلف أنحاء العالم، حيث يمكن للجميع التعبير عن أنفسهم وبناء علاقات حقيقية داخل المنصة.",
  },
];
    ...
    <div className="w-full">
      <section className="w-full bg-gradient-to-br from-red-50 to-rose-100 dark:from-gray-900 dark:to-gray-800 py-20 sm:py-32">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white">من نحن - فريق دريدود</h1>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          {sections.map((section) => (
            ...
            >
              ...
              <p className="mt-4 text-gray-700 dark:text-gray-300 leading-relaxed">{section.body}</p>
              {section.list && (
      ...
      <section className="w-full py-20 sm:py-32 bg-gray-900 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-gray-300 leading-relaxed">شكرًا لانضمامك إلى دريدود. معًا نبني تجربة تواصل اجتماعي أفضل.</p>
        </div>
      </section>
    </div>
  );
